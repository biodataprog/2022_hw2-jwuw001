...
awk -F, '{print $2}' calfires_2021.csv | sort -n | tail -n 5
#nano calfires_2021.csv
...
awk -F, '{print $2}' calfires_2021.csv | tail -n +2 | wc -l
#     134
TOTALFILECOUNT=134
...
awk -F, '{print $2}' calfires_2021.csv | sort -n | uniq -c | tail -n +2
#     39 2017
#     21 2018
#     11 2019
#     44 2020
